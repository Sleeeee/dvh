...
/* Pin connection*/
#define ST7789_RST_PORT SCREEN_RES_GPIO_Port
#define ST7789_RST_PIN  SCREEN_RES_Pin
#define ST7789_DC_PORT  SCREEN_DC_GPIO_Port
#define ST7789_DC_PIN   SCREEN_DC_Pin
...
#define BLK_PORT SCREEN_BLK_GPIO_Port
#define BLK_PIN SCREEN_BLK_Pin


/*
 * Comment one to use another.
 * 3 parameters can be chosen
